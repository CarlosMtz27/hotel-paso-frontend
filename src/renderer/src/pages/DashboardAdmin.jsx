...
export default function DashboardAdmin() {
  ...
  return (
    <div className="p-8">
      {/* Header con botón Modo Empleado */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-500">Habitaciones Totales</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="font-semibold text-gray-900">Tipos de Habitación</h3>
              <p className="text-sm text-gray-600">Gestionar tipos</p>
            </div>
          </div>
        </button>
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Gestionar habitaciones</p>
            </div>
          </div>
        </button>
